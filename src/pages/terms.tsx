  ...
  return (
    <div>
      <Layout titlePrefix='利用規約' pageTitle='利用規約' bgColorClass='bg-low' description='コトハジメの利用規約'>
        ...
        <RuleSentence title='第3条（ユーザーIDおよびパスワードの管理）'>
          <ol className='list-decimal'>
            <li>ユーザーは、GoogleまたはGitHubによるログインを用いて、本サービスを利用することができます。</li>
            <li>本サービスでは別途パスワードの設定はありません。</li>
          </ol>
        </RuleSentence>

        <RuleSentence title='第4条（禁止事項）'>
          <ol className='list-decimal'>
        ...
        <RuleSentence title='第5条（本サービスの提供の停止等）'>
          <ol className='list-decimal'>
            <li>
              ...
              <ol className='list-decimal'>
                ...
                <li>即急に対処できないセキュリティリスクが見つかった場合</li>
        ...
        <RuleSentence title='第6条（利用制限および登録抹消）'>
          <ol className='list-decimal'>
            <li>
        ...
        <RuleSentence title='第7条（退会）'>
          ユーザーは、当サービス提供者の定める退会手続により、本サービスから退会できるものとします。
        </RuleSentence>
        <RuleSentence title='第8条（保証の否認および免責事項）'>
          <ol className='list-decimal'>
            <li>
              当サービス提供者は、本サービスに事実上または法律上の瑕疵（安全性、信頼性、正確性、完全性、有効性、特定の目的への適合性、セキュリティなどに関する欠陥、エラーやバグ、権利侵害などを含みます。）がないことを明示的にも黙示的にも保証しておりません。
            </li>
            <li>
              当サービス提供者は、アンケートデータなどのバックアップを保証しておりません。当サービス提供者の過失でデータが消失した場合であっても保証などは一切致しませんのでユーザー自身で定期的にバックアップをお取りください。バックアップについては設定のエクスポートよりアンケートデータを定期的にダウンロードし、ユーザー自身で保管することをおすすめいたします。
            </li>
            <li>
        ...
        <RuleSentence title='第13条（準拠法・裁判管轄）'>
          <ol className='list-decimal'>
